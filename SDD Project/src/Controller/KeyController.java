...
public class KeyController implements KeyListener {
    ...
    private final KineticState kinetic;   //stuff for state design pattern
    private final LaserState laser;       //stuff for state design pattern
    private final MissileState missile;   //stuff for state design pattern
            ...
            case KeyEvent.VK_SPACE:
                ...
                switch (mainShip.getWeaponState()) {
                    case 0: //kinetic
                         ...
                         */
                        KeyController.bullet.setState(kinetic, mainShip.getLevelState());
                         ...
                         */
                        KeyController.bullet.fire(mainShip.getX(), mainShip.getY());
                        Sound.shot.play();
                        break;
                    case 1: //laser
                        KeyController.bullet.setState(laser, mainShip.getLevelState());
                        //System.out.println(this.bullet.getState().toString());
                        KeyController.bullet.fire(mainShip.getX(), mainShip.getY());
                        Sound.shot3.play();
                        break;
                    case 2: //missile
                        KeyController.bullet.setState(missile, mainShip.getLevelState());
                        //System.out.println(this.bullet.getState().toString());
                        KeyController.bullet.fire(mainShip.getX(), mainShip.getY());
                        Sound.shot2.play();
                        break;
